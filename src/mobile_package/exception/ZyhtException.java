 ...
 * @date 2017-08-22
 */
public class ZyhtException extends RuntimeException {
    static final long serialVersionUID = -7034898520345766939L;
     ...
     * @since 1.7
     */
    protected ZyhtException(String message, Throwable cause,
